...
public class MeterReadingSerivceTest {
    ...
    public void testFilterByArea() {
        ...
        Area area = new Area();
        area.setId(1L);
        area.setCity("Quảng Ninh");
        area.setDistrict("Hạ Long");
        area.setWardCommune("Bãi Cháy");
        ...
        assertEquals(100, meters1.get(0).getPreviousReading());
        assertEquals(100, meters1.get(1).getPreviousReading());
        assertEquals(100, meters1.get(2).getCurrentReading());
