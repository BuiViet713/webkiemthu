...
public class ElectricityTariffTest {
    ...
    @Test
    public void testCalculatePrice_StandardCase1_CalculateAt50Consumption002() {
        List<AmountByStep> resultList = electricityTariff.calculatePrice(10000);
        double result;
        if(resultList.isEmpty()) {
            result = -1;
        } else {
